@REM play_project_1 launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM PLAY_PROJECT_1_config.txt found in the PLAY_PROJECT_1_HOME.
@setlocal enabledelayedexpansion

@echo off


if "%PLAY_PROJECT_1_HOME%"=="" (
  set "APP_HOME=%~dp0\\.."

  rem Also set the old env name for backwards compatibility
  set "PLAY_PROJECT_1_HOME=%~dp0\\.."
) else (
  set "APP_HOME=%PLAY_PROJECT_1_HOME%"
)
...
set "CFG_FILE=%APP_HOME%\PLAY_PROJECT_1_config.txt"
set CFG_OPTS=
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running play_project_1.
  echo.
...
"%_JAVACMD%" !_JAVA_OPTS! !PLAY_PROJECT_1_OPTS! -cp "%APP_CLASSPATH%" %MAIN_CLASS% !_APP_ARGS!
